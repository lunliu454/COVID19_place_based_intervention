...
window_wide <- 7                                                                           #time window used to estimate Rt
all_data <- read_csv(" ")                                                         #loading data from csv file 
all_data$add[is.na(all_data$add)] <- 0                                                     #case report starts from second days
all_data$eng <- as.factor(all_data$eng)                                                    #label each city or region in a country
